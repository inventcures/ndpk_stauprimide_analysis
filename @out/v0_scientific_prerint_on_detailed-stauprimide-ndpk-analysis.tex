...
The Kpn loop is essential for the "clamp" mechanism that stabilizes the hexameric interface, especially in the NME1-NME2 heterohexamer context \cite{lim2024}. RMSF analysis (Figure \ref{fig:rmsf}) shows that Stauprimide binding significantly dampens the fluctuations of the Kpn loop in NME2.
